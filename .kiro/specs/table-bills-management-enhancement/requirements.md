...
### Requirement 9: عرض الطلبات في صفحة Cafe

**User Story:** كمستخدم للنظام، أريد أن أرى فقط الطلبات المرتبطة بفواتير غير مدفوعة على الطاولات في صفحة Cafe، حتى أتمكن من التركيز على الطلبات النشطة فقط.

#### Acceptance Criteria

1. WHEN المستخدم ينقر على طاولة في صفحة Cafe THEN النظام SHALL يعرض فقط الطلبات المرتبطة بفواتير غير مدفوعة
2. WHEN طلب مرتبط بفاتورة مدفوعة بالكامل THEN النظام SHALL لا يعرض هذا الطلب على الطاولة
3. WHEN طلب غير مرتبط بأي فاتورة THEN النظام SHALL يعرض هذا الطلب على الطاولة
4. WHEN فاتورة تتحول من غير مدفوعة إلى مدفوعة THEN النظام SHALL يخفي الطلبات المرتبطة بها من عرض الطاولة تلقائياً
5. WHEN المستخدم يعرض صفحة Cafe THEN النظام SHALL يحدث عرض الطلبات تلقائياً عند تغيير حالة الفواتير
