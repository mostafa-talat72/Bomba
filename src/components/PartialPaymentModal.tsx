        ...
        <div className="sticky top-0 z-10 p-3 sm:p-6 bg-gradient-to-r from-green-600 to-emerald-600 dark:from-green-700 dark:to-emerald-700 flex items-center justify-between rounded-t-2xl">
          <div className="flex items-center gap-2 sm:gap-4 flex-1 min-w-0">
            ...
            <div className="min-w-0 flex-1">
              <h3 className="text-xl sm:text-2xl font-bold text-white truncate">{t('billing.partialPaymentModal.title')}</h3>
        ...
        <div className="p-3 sm:p-6">
          ...
          <div className="mb-4 sm:mb-6">
            ...
            {availableItems.length === 0 ? (
              <div className="text-center py-8 sm:py-12 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/30 dark:to-emerald-900/30 rounded-xl border-2 border-green-300 dark:border-green-700 shadow-lg">
                ...
                <h5 className="font-bold text-base sm:text-lg text-green-900 dark:text-green-100 mb-2">{t('billing.partialPaymentModal.allItemsPaid')}</h5>
                <p className="text-green-700 dark:text-green-300 text-sm sm:text-base px-4">
                  ...
                  <div key={item.id} className="bg-gradient-to-br from-white to-gray-50 dark:from-gray-700 dark:to-gray-800 rounded-xl p-3 sm:p-5 border-2 border-green-200 dark:border-green-700 shadow-md hover:shadow-lg transition-all">
                    ...
                    <div className="flex items-center justify-between mb-3 sm:mb-4">
                      <div className="flex items-center gap-2 sm:gap-3 flex-1 min-w-0">
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <div className="text-xs sm:text-sm text-purple-600 dark:text-purple-400 bg-purple-100 dark:bg-purple-900/50 px-2 py-0.5 rounded-lg inline-block mt-1">
                    ...
                    <div className="grid grid-cols-3 gap-2 sm:gap-3 mb-3 sm:mb-4">
                      <div className="text-center p-2 sm:p-3 bg-gray-100 dark:bg-gray-800 rounded-lg">
                        ...
                        <div className="font-bold text-sm sm:text-base text-gray-900 dark:text-gray-100">{formatDecimal(item.totalQuantity, i18n.language)}</div>
                      </div>
                      <div className="text-center p-2 sm:p-3 bg-green-100 dark:bg-green-900/50 rounded-lg">
                        ...
                        <div className="font-bold text-sm sm:text-base text-green-800 dark:text-green-200">{formatDecimal(item.paidQuantity, i18n.language)}</div>
                      </div>
                      <div className="text-center p-2 sm:p-3 bg-orange-100 dark:bg-orange-900/50 rounded-lg">
                        ...
                        <div className="font-bold text-sm sm:text-base text-orange-800 dark:text-orange-200">{formatDecimal(item.remainingQuantity, i18n.language)}</div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between flex-wrap gap-3">
                      <div className="flex items-center gap-2 sm:gap-3 bg-green-100 dark:bg-green-900/50 px-3 sm:px-4 py-2 rounded-lg">
                        ...
                        <span className="mx-1 sm:mx-2 w-8 sm:w-12 text-center select-none font-bold text-xl sm:text-2xl text-green-700 dark:text-green-300">
                      ...
                      <button
                        type="button"
                        className="px-3 sm:px-4 py-2 bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white text-sm font-bold rounded-lg shadow-md hover:shadow-lg transition-all transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
          ...
          {hasSelectedItems && (
            <div className="mb-4 sm:mb-6 bg-orange-50 dark:bg-orange-900 p-3 sm:p-4 rounded-lg border border-orange-200 dark:border-orange-700">
              <h4 className="font-medium text-base sm:text-lg text-orange-900 dark:text-orange-100 mb-2">{t('billing.partialPaymentModal.paymentSummary')}</h4>
