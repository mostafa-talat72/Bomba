                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <label className="relative inline-flex items-center cursor-pointer">
                          <input
                            type="checkbox"
                            checked={organization.printSettings?.autoPrintOnPayment ?? false}
                            onChange={(e) =>
                              setOrganization({
                                ...organization,
                                printSettings: {
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          <h4 className="text-sm font-medium text-gray-900 dark:text-gray-100">
                            {t('settings.organization.printSettings.printMarksPaid')}
                          </h4>
                          <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                            {t('settings.organization.printSettings.printMarksPaidDesc')}
                          </p>
                        </div>
                        <label className="relative inline-flex items-center cursor-pointer">
                          <input
                            type="checkbox"
                            checked={organization.printSettings?.printMarksPaid ?? false}
                            onChange={(e) =>
                              setOrganization({
                                ...organization,
                                printSettings: {
                                  ...organization.printSettings,
                                  printMarksPaid: e.target.checked,
                                },
                              })
                            }
                            className="sr-only peer"
