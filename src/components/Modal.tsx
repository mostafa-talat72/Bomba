        ...
        <div className={`modal-content bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full ${maxWidth} max-h-[95vh] sm:max-h-[90vh] overflow-y-auto mx-2 sm:mx-0`}>
          <div className="sticky top-0 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-3 sm:px-6 py-3 sm:py-4 rounded-t-lg">
            <div className="flex items-center justify-between">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-gray-100 truncate pr-2">{title}</h2>
              {showCloseButton && (
                <button
                  className="text-gray-400 dark:text-gray-500 hover:text-gray-700 dark:hover:text-gray-300 text-3xl sm:text-4xl font-bold transition-colors duration-200 flex-shrink-0"
                  onClick={onClose}
                >
