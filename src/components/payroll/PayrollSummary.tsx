...
import { Card, Row, Col, DatePicker, Button, Space, Table, Tag, Spin, Empty, Divider, message, ConfigProvider } from 'antd';
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (amount: number = 0) => (
        <span className="font-medium text-green-600">{(amount || 0).toFixed(2)} {currency()}</span>
      )
    },
    {
      title: t('payroll.payrollSummary.table.bonuses'),
      dataIndex: 'bonuses',
      key: 'bonuses',
      render: (amount: number = 0) => (
        <span className="text-blue-600">+{(amount || 0).toFixed(2)} {currency()}</span>
      )
    },
    {
      ...
      key: 'advances',
      render: (amount: number = 0) => (
        <span className="text-orange-600">-{(amount || 0).toFixed(2)} {currency()}</span>
      )
    },
    {
      ...
      key: 'otherDeductions',
      render: (amount: number = 0) => (
        <span className="text-red-600">-{(amount || 0).toFixed(2)} {currency()}</span>
      )
    },
    {
      ...
      key: 'deductions',
      render: (amount: number = 0) => (
        <span className="text-red-600 font-medium">-{(amount || 0).toFixed(2)} {currency()}</span>
      )
    },
    {
      ...
      key: 'netSalary',
      render: (amount: number = 0) => (
        <span className="font-bold text-blue-600">{(amount || 0).toFixed(2)} {currency()}</span>
      )
    },
    {
      ...
      key: 'paidAmount',
      render: (amount: number = 0) => (
        <span className="text-green-700">{(amount || 0).toFixed(2)} {currency()}</span>
      )
    },
    {
    ...
    },
    {
      ...
      render: (amount: number = 0) => (
        <span className={amount > 0 ? 'text-red-600 font-medium' : 'text-gray-400'}>
          {(amount || 0).toFixed(2)} {currency()}</span>
      )
    },
    {
          ...
          return (
            <div className="flex flex-col items-center">
              ...
              <span className="text-xs text-green-600 font-bold mt-1">
                +{(totalUnpaid || 0).toFixed(2)} {currency()}
              </span>
            </div>
          );
          ...
          return (
            <div className="flex flex-col items-center">
              ...
              <span className="text-xs text-red-600 font-bold mt-1">
                {Math.abs(totalUnpaid || 0).toFixed(2)} {currency()}
              </span>
            </div>
          );
        } else {
          ...
          <Row gutter={[16, 16]}>
            ...
            <Col xs={24} sm={12} lg={8}>
              <Card className="hover:shadow-lg transition-shadow">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-gray-600 dark:text-gray-400 text-sm mb-1">{t('payroll.payrollSummary.stats.totalBonuses')}</p>
                    <p className="text-3xl font-bold text-blue-600">
                      {(summaryData.statistics.totalBonuses || 0).toFixed(2)}
                    </p>
              ...
              <Card className="hover:shadow-lg transition-shadow">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-3xl font-bold text-green-600">
                      {(summaryData.statistics.totalGrossSalary || 0).toFixed(2)}
                    </p>
                    <p className="text-xs text-gray-500">{currency()}</p>
                  </div>
                  <div className="w-16 h-16 bg-green-100 dark:bg-green-900/30 rounded-full flex items-center justify-center">
              ...
              <Card className="hover:shadow-lg transition-shadow">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-3xl font-bold text-red-600">
                      {(summaryData.statistics.totalDeductions || 0).toFixed(2)}
                    </p>
                    <p className="text-xs text-gray-500">{currency()}</p>
                  </div>
                  <div className="w-16 h-16 bg-red-100 dark:bg-red-900/30 rounded-full flex items-center justify-center">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-4xl font-bold text-blue-700 dark:text-blue-400">
                      {(summaryData.statistics.totalNetSalary || 0).toFixed(2)}
                    </p>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-3xl font-bold text-green-700">
                      {(summaryData.statistics.totalPaid || 0).toFixed(2)}
                    </p>
                    <p className="text-xs text-gray-500">{currency()}</p>
                  </div>
                  <div className="w-16 h-16 bg-green-100 dark:bg-green-900/30 rounded-full flex items-center justify-center">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-3xl font-bold text-orange-600">
                      {(summaryData.statistics.totalUnpaidCurrentMonth || 0).toFixed(2)}
                    </p>
                    <p className="text-xs text-gray-500">{currency()}</p>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-3xl font-bold text-red-700 dark:text-red-400">
                      {(summaryData.statistics.totalEmployeeDebts || 0).toFixed(2)}
                    </p>
                    <p className="text-xs text-gray-600 dark:text-gray-400">{currency()}</p>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className={`text-3xl font-bold ${
                      ...
                      {(summaryData.statistics.totalCarriedForward || 0).toFixed(2)}
                    </p>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className={`text-4xl font-extrabold ${
                      ...
                      {(summaryData.statistics.totalUnpaid || 0).toFixed(2)}
                    </p>
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center p-3 bg-orange-50 dark:bg-orange-900/20 rounded">
                    ...
                    <span className="font-bold text-orange-600">
                      {(summaryData.statistics.totalAdvances || 0).toFixed(2)} {currency()}
                    </span>
                  </div>
                  ...
                  <div className="flex justify-between items-center p-3 bg-red-100 dark:bg-red-900/30 rounded">
                    ...
                    <span className="font-bold text-xl text-red-700">
                      {(summaryData.statistics.totalDeductions || 0).toFixed(2)} {currency()}
                    </span>
                  </div>
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center p-3 bg-green-50 dark:bg-green-900/20 rounded">
                    ...
                    <span className="font-bold text-green-600">
                      +{(summaryData.statistics.totalGrossSalary || 0).toFixed(2)} {currency()}
                    </span>
                  </div>
                  <div className="flex justify-between items-center p-3 bg-blue-50 dark:bg-blue-900/20 rounded">
                    <span className="text-gray-700 dark:text-gray-300 font-medium">{t('payroll.payrollSummary.stats.totalBonuses')}</span>
                    <span className="font-bold text-blue-600">
                      +{(summaryData.statistics.totalBonuses || 0).toFixed(2)} {currency()}
                    </span>
                  </div>
                  <div className="flex justify-between items-center p-3 bg-red-50 dark:bg-red-900/20 rounded">
                  ...
                  <div className="flex justify-between items-center p-3 bg-blue-100 dark:bg-blue-900/30 rounded">
                    ...
                    <span className="font-bold text-xl text-blue-700">
                      {(summaryData.statistics.totalNetSalary || 0).toFixed(2)} {currency()}
                    </span>
                  </div>
                  <div className="text-xs text-gray-500 dark:text-gray-400 mt-2 text-center">
                    {(summaryData.statistics.totalGrossSalary || 0).toFixed(2)} + {(summaryData.statistics.totalBonuses || 0).toFixed(2)} - {(summaryData.statistics.totalDeductions || 0).toFixed(2)} = {(summaryData.statistics.totalNetSalary || 0).toFixed(2)} {currency()}
                  </div>
                </div>
              </Card>
            </Col>
