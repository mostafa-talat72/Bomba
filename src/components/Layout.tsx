...
const Layout = () => {
  ...
  const navigation = [
    ...
    { name: t('nav.consumptionReport'), href: '/consumption-report', icon: Package2, permissions: ['reports', 'consumption'] },
    { name: t('nav.soldItems'), href: '/sold-items', icon: ShoppingBag, permissions: ['soldItems'] },
    ...
    { name: t('nav.payroll'), href: '/payroll', icon: DollarSign, permissions: ['users', 'payroll'] },
    ...
    { name: t('nav.notifications'), href: '/notifications', icon: Bell, permissions: ['dashboard', 'playstation', 'computer', 'tables', 'cafe', 'menu', 'billing', 'reports', 'inventory', 'warehouse', 'costs', 'users', 'settings', 'notifications'], badge: unreadNotifications },
    { name: t('nav.subscriptions'), href: '/subscription', icon: CreditCard, permissions: ['subscription'] },
