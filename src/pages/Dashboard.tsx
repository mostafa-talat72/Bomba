...
const Dashboard = () => {
  ...
  return (
    <div className="space-y-8">
      {/* Welcome Section */}
      <div className="bg-gradient-to-r from-primary-600 to-primary-700 dark:from-primary-700 dark:to-primary-800 rounded-xl p-8 text-white shadow-lg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {stats.map((stat) => {
          ...
          return (
            <div key={stat.name} className={`${stat.bgColor} dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700 hover:shadow-md transition-all duration-300`}>
          ...
          <div className="p-6">
            {activeSessions.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="text-gray-500 dark:text-gray-400 text-lg font-medium">لا توجد جلسات نشطة حالياً</p>
                <p className="text-gray-400 dark:text-gray-500 text-sm mt-1">جميع الأجهزة متاحة للاستخدام</p>
              </div>
            ) : (
              <div className="space-y-4">
                {activeSessions.slice(0, 5).map((session) => {
                  ...
                  const minutes = Math.floor((durationMs % (1000 * 60 * 60)) / (1000 * 60));
                                     ...
                                     return (
                     <div key={session.id} className="flex items-center justify-between p-4 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900 dark:to-indigo-900 rounded-lg border border-blue-100 dark:border-blue-700 hover:shadow-sm transition-shadow duration-200">
                       <div className="flex items-center">
                         ...
                         <div className="mr-4">
                           <p className="font-semibold text-gray-900 dark:text-gray-100">{session.deviceName}</p>
                       ...
                       <div className="text-left">
                         <p className="font-bold text-green-600 dark:text-green-400 text-lg">{currentCost}</p>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
          <div className="p-6 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900 dark:to-emerald-900">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 flex items-center">
              ...
              النشاط الأخير
              <span className="bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200 text-xs font-medium px-2 py-1 rounded-full mr-2">
          ...
          <div className="p-6">
            {recentActivity.length === 0 ? (
              <div className="text-center py-8">
                ...
                <p className="text-gray-400 dark:text-gray-500 text-sm mt-1">سيظهر النشاط هنا عند بدء الجلسات أو الطلبات</p>
              </div>
            ) : (
              <div className="space-y-4">
                {recentActivity.slice(0, 5).map((activity) => {
                  ...
                  return (
                    <div key={activity.id} className="flex items-center p-3 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-lg transition-colors duration-200">
                      <div className={`w-10 h-10 bg-gray-100 dark:bg-gray-700 rounded-full flex items-center justify-center ${activity.color}`}>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center p-4 bg-green-50 dark:bg-green-900 rounded-lg border border-green-200 dark:border-green-700">
              <div className="w-12 h-12 bg-green-100 dark:bg-green-800 rounded-full flex items-center justify-center mx-auto mb-3">
                <div className="w-3 h-3 bg-green-500 rounded-full"></div>
              </div>
              <h4 className="font-semibold text-green-800 dark:text-green-200 mb-1">النظام يعمل</h4>
            ...
            <div className="text-center p-4 bg-blue-50 dark:bg-blue-900 rounded-lg border border-blue-200 dark:border-blue-700">
              ...
              <h4 className="font-semibold text-blue-800 dark:text-blue-200 mb-1">المستخدمون النشطون</h4>
              <p className="text-sm text-blue-600 dark:text-blue-400">
                {realTimeActiveSessions > 0 ? `${formatDecimal(realTimeActiveSessions)} جلسة نشطة` : 'لا توجد جلسات نشطة'}
              </p>
            </div>
            <div className="text-center p-4 bg-orange-50 dark:bg-orange-900 rounded-lg border border-orange-200 dark:border-orange-700">
              ...
              <h4 className="font-semibold text-orange-800 dark:text-orange-200 mb-1">الطلبات المعلقة</h4>
